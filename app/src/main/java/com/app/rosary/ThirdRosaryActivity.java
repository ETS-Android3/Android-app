...
public class ThirdRosaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fatima = pref.getString("saved_fatima", "false");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.setting:
                startActivity(new Intent(ThirdRosaryActivity.this, SettingsActivity.class));
                break;
            case R.id.mystery:
                startActivity(new Intent(ThirdRosaryActivity.this, Mysteries.class));
                break;
            case R.id.home:
                startActivity(new Intent(ThirdRosaryActivity.this, MainActivity.class));
                break;
        }
    ...
    private void onClick(View v){
        if(v.getId() == R.id.tab5Button){
            startActivity(new Intent(ThirdRosaryActivity.this, SecondRosaryActivity.class));
        }
